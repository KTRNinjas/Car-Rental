<?php 
 function create_cars($kapcsolat){
    ...
    Query($kapcsolat, "Az egyedi autó tábla létrehozása", $sql);
  }
  function create_valtotipus($kapcsolat){
    ...
    Query($kapcsolat, "A váltótípus tábla létrehozása", $sql);
  }
  function create_hajtaslanc($kapcsolat){
    ...
    Query($kapcsolat, "A hajtáslánc tábla létrehozása", $sql);
  }
