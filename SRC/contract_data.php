<?php 
  ...
  function Contract_create($kapcsolat){
    ...
    $uzenet="contract1 létrehozasa";
    Query($kapcsolat,$uzenet,$sql);
    $sql="INSERT INTO `autokolcsonzo`.`contract` (`id`, `Kezdődátum`, `Végdátum`, `Account_ID`, `Visszavétel_időpontja`) VALUES (NULL, '2022-09-01', '2022-09-10', '0', '2022-09-11')";
    $uzenet="contract2 létrehozasa";
    Query($kapcsolat,$uzenet,$sql);
  ...
  function Contract_car_table_beszuro($kapcsolat){
    ...
    Query($kapcsolat,$uzenet,$sql);
    $sql="INSERT INTO `autokolcsonzo`.`contract_car_join` (`ID`, `Car_ID`, `Contract_ID`) VALUES (NULL, '1', '2')";
    $uzenet="Contract_car tablaba a beszuras";
    Query($kapcsolat,$uzenet,$sql);
    $sql="INSERT INTO `autokolcsonzo`.`contract_car_join` (`ID`, `Car_ID`, `Contract_ID`) VALUES (NULL, '3', '3')";
    $uzenet="Contract_car tablaba a beszuras";
    Query($kapcsolat,$uzenet,$sql);
    $sql="INSERT INTO `autokolcsonzo`.`contract_car_join` (`ID`, `Car_ID`, `Contract_ID`) VALUES (NULL, '1', '1')";
    $uzenet="Contract_car tablaba a beszuras";
    Query($kapcsolat,$uzenet,$sql);
  }
