...
class AdminControllerTest extends \Codeception\Test\Unit
{
    ...
    public function test_if_vasarlo_Is_Preselected_in_legördülő()
    {
        ...
        //Then
        $this->assertEquals('<select><option value="1" selected>vásárló</option><option value="2">admin</option><option value="3">főnök</option></select>', $result);
    }
    public function test_if_admin_Is_Preselected_in_legördülő()
    {
        ...
        $this->assertEquals('<select><option value="1">vásárló</option><option value="2" selected>admin</option><option value="3">főnök</option></select>', $result);
    }
    public function test_if_fonok_Is_Preselected_in_legördülő()
    {
        ...
        $this->assertEquals('<select><option value="1">vásárló</option><option value="2">admin</option><option value="3" selected>főnök</option></select>', $result);
    }
}
