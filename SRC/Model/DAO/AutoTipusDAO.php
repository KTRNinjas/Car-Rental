...
function AutoTipusTarolo($Marka,$Tipus,$Premium,$Ar)
{
    $kapcsolat = $GLOBALS["kapcsolat"];
    $sql = "INSERT INTO `autokolcsonzo`.`autotipus` (`ID`, `Márka`,`Tipus`,  `Prémium`, `Ar`) VALUES (NULL, '$Marka','$Tipus', '$Premium', '$Ar')"; // modositott
